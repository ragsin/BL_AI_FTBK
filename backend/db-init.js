...
async function seed(client) {
    ...
    try {
        ...
        console.error('--- Error during database seed, rolling back ---');
        throw err;
    }
}
...
export async function initializeDatabase() {
    ...
    try {
        // Check if the users table exists and has data as a proxy for being seeded
        ...
        // If the initial check fails (e.g., table doesn't exist), the schema is likely missing.
        if (err.code === '42P01' || !res.rows[0].to_regclass) {
